...
<section class="flex flex-col justify-center antialiased bg-gh-1 text-white min-h-screen p-4">
    <div class="h-full">
        ...
        <div class="max-w-5xl mx-auto" x-data="{ annual: true }">
            <h2 class="text-3xl text-white font-bold text-center mb-4">Plans</h2>

            <div class="flex justify-center">
                <div class="flex items-center space-x-3 mb-8">
                    <div class="text-sm text-white font-medium min-w-[120px] text-right">Monthly</div>
                    ...
                    <div class="text-sm text-white font-medium min-w-[120px]">Annually <span class="text-green-500">(-20%)</span></div>
                </div>
            </div>
                ...
                <div class="relative col-span-full md:col-span-4 bg-black shadow-md rounded-sm border border-gray-200">
                    ...
                    <div class="px-5 pt-5 pb-6 border-b border-gray-200">
                        <header class="flex items-center mb-2">
                            ...
                            <h3 class="text-lg text-white font-semibold">Basic</h3>
                        </header>
                        ...
                        <div class="text-white font-bold mb-4">
                            <span class="text-2xl">$</span><span class="text-3xl" x-text="annual ? '14' : '19'">14</span><span class="text-white font-medium text-sm">/mo</span>
                        </div>

                        <button class="font-medium text-sm inline-flex items-center justify-center px-3 py-2 border border-gray-200 rounded leading-5 shadow-sm transition duration-150 ease-in-out focus:outline-none focus-visible:ring-2 hover:border-gray-300 text-white w-full">Downgrade</button>
                    </div>
                    <div class="px-5 pt-4 pb-5">
                        <div class="text-xs text-white font-semibold uppercase mb-4">What's included</div>
                ...
                <div class="relative col-span-full md:col-span-4 bg-slate-900 shadow-md rounded-sm border border-gray-200">
                    ...
                    <div class="px-5 pt-5 pb-6 border-b border-gray-200">
                        <header class="flex items-center mb-2">
                            ...
                            <h3 class="text-lg text-white font-semibold">Standard</h3>
                        </header>
                        <div class="text-sm mb-2">Ideal for individuals that need a custom solution with custom tools.</div>

                        <div class="text-white font-bold mb-4">
                            <span class="text-2xl">$</span><span class="text-3xl" x-text="annual ? '34' : '39'">34</span><span class="text-white font-medium text-sm">/mo</span>
                        </div>

                        <button class="font-medium text-sm inline-flex items-center justify-center px-3 py-2 border border-transparent rounded leading-5 shadow-sm transition duration-150 ease-in-out border-gray-200 focus:outline-none focus-visible:ring-2 bg-gray-100 text-white w-full cursor-not-allowed flex items-center" disabled>
                            <svg class="w-3 h-3 flex-shrink-0 fill-current mr-2 bg-black text-blue-300" viewBox="0 0 12 12">
                                <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
                            </svg>
                            <span className="selectedPlan">Current Plan</span>
                        </button>
                    </div>
                    <div class="px-5 pt-4 pb-5">
                        <div class="text-xs text-white font-semibold uppercase mb-4">What's included</div>
                ...
                <div class="relative col-span-full md:col-span-4 bg-slate-900 shadow-md rounded-sm border border-gray-200">
                    ...
                    <div class="px-5 pt-5 pb-6 border-b border-gray-200">
                        <header class="flex items-center mb-2">
                            ...
                            <h3 class="text-lg text-white font-semibold">Plus</h3>
                        </header>
                        <div class="text-sm mb-2">Ideal for individuals that need a custom solution with custom tools.</div>

                        <div class="text-white font-bold mb-4">
                            <span class="text-2xl">$</span><span class="text-3xl" x-text="annual ? '74' : '79'">74</span><span class="text-white font-medium text-sm">/mo</span>
                        </div>
            ...
            <form action="#">
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        <label for="email" class="hidden mb-2 text-sm font-medium text-white dark:text-gray-300">Email address</label>
